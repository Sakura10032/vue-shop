<template>
  <div>
    ...
    <el-card>
      ...
      <el-form :model="addForm" :rules="addFormRules" label-position="top" label-width="100px" ref="addFormRef">
        <el-tabs :before-leave="beforeTabLeave" :tab-position="'left'" @tab-click="tabClicked" v-model="activeIndex">
