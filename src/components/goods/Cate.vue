<template>
  <div>
    ...
    <!-- 添加分类的对话框 -->
    <el-dialog :visible.sync="addCateDialogVisible" @close="addCateDialogClosed" title="添加分类" width="50%">
      <!-- 添加分类的表单 -->
      <el-form :model="addCateForm" :rules="addCateFormRules" label-width="100px" ref="addCateFormRef">
